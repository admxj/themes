		...
		<div class="col-md-2">
	        ...
	        <div class="row">
	        	<div class="copyright">
	        		...
	        		<span class="hidden-xs">Theme by <a href="http://www.admxj.com">逗逗笔记</a> & <a href="http://admxj.com">蔡妈看看</a></span>
	        		<span class="hidden-xs">加载用时：</span><span><?php timer_stop(1); ?>s</span>
	        		<a href="tencent://message/?uin=1136308698&Site=121ask.com&Meu=yes" class="kefu pull-right hidden-xs"><i class="fa fa-qq"></i>在线联系我</a>
	        	</div>
	        </div>
	    </div>
	</div>
...
<!-- 菜单&侧边栏按钮 -->
<div class="menu mobile-menuicon hidden-sm">
